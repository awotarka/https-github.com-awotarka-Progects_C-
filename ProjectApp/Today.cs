...
namespace ProjectApp
{
    public partial class Today : UserControl
    {
        ...
        void getTargets()
        {
            ...
            {
                SQL.Open();
                SqlCommand command = new SqlCommand("SELECT * FROM TargetTable WHERE TargerID = 2", SQL);
        ...
        public void addTargets(string insert)
        {
            ...
            {
                SQL.Open();
                SqlCommand commandsec = new SqlCommand("INSERT INTO TargetTable (TargetText, TargerID) VALUES ('" + insert + "','2')", SQL);
