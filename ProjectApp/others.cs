...
namespace ProjectApp
{
    public partial class Others : UserControl
    {
        ...
        void getTargets()
        {
            ...
            {
                SQL.Open();
                SqlCommand command = new SqlCommand("SELECT * FROM TargetTable WHERE TargerID = 4", SQL);
        ...
        public void addTargets(string insert)
        {
            ...
            {
                SQL.Open();
                SqlCommand commandsec = new SqlCommand("INSERT INTO TargetTable (TargetText, TargerID) VALUES ('" + insert + "','4')", SQL);
