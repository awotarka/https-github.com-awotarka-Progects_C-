...
namespace ProjectApp
{
    public partial class Week : UserControl
    {
        ...
        void getTargets()
        {
            ...
            {
                SQL.Open();
                SqlCommand command = new SqlCommand("SELECT * FROM TargetTable WHERE TargerID = 3", SQL);
        ...
        public void addTargets(string insert)
        {
            ...
            {
                SQL.Open();
                SqlCommand commandsec = new SqlCommand("INSERT INTO TargetTable (TargetText, TargerID) VALUES ('" + insert + "','3')", SQL);
